    ...
    <div class="auth-form-container">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="password" name="password_confirmation" required class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
            <div>
            <div>
    <div>
    <label class="block text-gray-700 font-semibold mb-1">Register As</label>
    <div class="flex items-center space-x-6">
        <label class="inline-flex items-center">
            <input type="radio" name="role" value="user" checked class="form-radio text-blue-600">
            <span class="ml-2 text-white">Customer</span>
        </label>
        <label class="inline-flex items-center">
            <input type="radio" name="role" value="vendor" class="form-radio text-blue-600">
            <span class="ml-2 text-white">Vendor</span>
        </label>
    </div>
</div>
